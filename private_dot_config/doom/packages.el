...
(package! org-gh
  :recipe (:local-repo "lisp/org-gh"))

;; (package! pymacs
;;   :recipe (:local-repo "/Users/bm13805/pymacs.el"))


;; code cell minor mode for jupytext
(package! code-cells
...
;; gptel - now built in to doom
;;(package! gptel :recipe (:nonrecursive t))

;; Primary tools/presets: web + filesystem + bash + Emacs introspection
(package! gptel-agent
  :recipe (:host github :repo "karthink/gptel-agent"))


;; Secondary tool collection (not in package archives yet; install from GitHub)
