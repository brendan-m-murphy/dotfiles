...
(ert-deftest my/org-set-macher-root-sets-property ()
  (let ((tmp (make-temp-file "macher-prop" t)))
    (unwind-protect
        (my/macher-test--with-org-buffer
            "* Task\n"
          (my/org-set-macher-root tmp)
          (should (equal (org-entry-get nil "MACHER_ROOT")
